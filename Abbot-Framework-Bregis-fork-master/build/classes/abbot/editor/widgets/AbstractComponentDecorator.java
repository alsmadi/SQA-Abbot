...
public abstract class AbstractComponentDecorator {
    ...
    public boolean isVisible() {
        ...
        // The isVisible method appears to have altered it functoinality, so instead we 
        // are going to perform an intersection of the bounds and painter bounds to find out
        // if the component is visibile or not.
        Rectangle componentBounds = component.getBounds();
        Rectangle painterBounds = painter.getBounds();

        Rectangle result = new Rectangle();
        
        Rectangle.intersect(componentBounds, painterBounds, result);

        return !result.isEmpty() && painter.isVisible(); // Won't be visible if painter disabled
    }
